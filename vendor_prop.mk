PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.config.alarm_alert=Haier_Ring.mp3 \
    ro.config.default_message0=Haier_Ring.mp3 \
    ro.config.default_message1=Haier_Ring.mp3 \
    ro.config.default_message=Haier_Ring.mp3 \
    ro.config.low_ram=true \
    ro.config.notification_sound=Haier_Ring.mp3 \
    ro.config.ringtone0=Haier_Ring.mp3 \
    ro.config.ringtone1=Haier_Ring.mp3 \
    ro.config.ringtone=Haier_Ring.mp3 \
    ro.control_privapp_permissions=log \
    ro.hardware.keystore=sprdtrusty \
    ro.hotspot.enabled=1 \
    ro.keybox.id.value=HAIER_A3_LITE \
